...
public class Main {
    public static void main(String[] args) throws IOException {
        ...
        while (!(line = reader.readLine()).equals("End")) {
            ...
            switch (input.length) {
                ...
                case 2:
                    ...
                    Person parent = nameOrBirthdayParent.contains("/") ? new Person("", nameOrBirthdayParent) : new Person(nameOrBirthdayParent, "");
                    Person child = nameOrBirthdayChild.contains("/") ? new Person("", nameOrBirthdayChild) : new Person(nameOrBirthdayChild, "");
        ...
        fullDataPeople.stream().forEach(person -> {
            if (person.getName().equals(personWanted.getName()) || person.getBirthday().equals(personWanted.getBirthday())) {
