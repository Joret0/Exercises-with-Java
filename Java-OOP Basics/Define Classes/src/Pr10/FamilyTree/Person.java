...
public class Person {
    ...
    public String toString() {
        ...
        this.getParents().stream().forEach(parent -> personBuilder.append(parent.getName()).append(" ").append(parent.getBirthday()).append(System.lineSeparator()));
        personBuilder.append("Children:\n");
        this.getChildren().stream().forEach(child -> personBuilder.append(child.getName()).append(" ").append(child.getBirthday()).append(System.lineSeparator()));
