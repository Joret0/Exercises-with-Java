...
import pr01VehiclesExtension.exception.BelowZeroFuelException;
import pr01VehiclesExtension.exception.OutOfFuelException;
...
public abstract class Vehicle {
    ...
    private void printTraveled(String vehicle, double distance) {
        ...
        System.out.printf("%s travelled %s km%n", vehicle, kilometers);
    }
