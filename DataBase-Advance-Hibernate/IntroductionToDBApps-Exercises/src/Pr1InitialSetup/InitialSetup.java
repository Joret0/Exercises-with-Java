...
public class InitialSetup {
    ...
    public static void main(String[] args) {
        ...
        villainsMinions.put("Gru",new String[]{"Petio","Niki","Maria","Yani"});
        villainsMinions.put("Aneta",new String[]{"Mitko","Penko","Nedialka","Elena"});
        villainsMinions.put("Georgi",new String[]{"Andrei","Krasio","Minko"});
        villainsMinions.put("Ivan",new String[]{"Viktor","Kolio"});
        villainsMinions.put("Alex",new String[]{"Vesela"});
