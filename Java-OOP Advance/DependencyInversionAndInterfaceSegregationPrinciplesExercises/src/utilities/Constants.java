...
public class Constants {
    static final String IncorrectModelLenghtMessage = "Model's name must be at least %s symbols long.";
    static final String IncorrectPropertyValueMessage = "%s must be a positive integer.";
